...
- Search 95 bundled generic foods, or scan a barcode for a branded one
...
**Generic foods** — chicken breast, oats, olive oil — ship with the app: 95
...
Bundling also means search works in flight mode, which is where this app is
supposed to work.
